...
public class VoiceTip {
    ...
    public static void initSoundPool(Context context){
        VoiceTip.context = context;
        sp = new SoundPool(1, AudioManager.STREAM_MUSIC, 1);
        suondMap = new HashMap<Integer, Integer>();
        suondMap.put(1, sp.load(context, R.raw.msg, 1));
        suondMap.put(2, sp.load(context, R.raw.error, 1));
    }

    //播放声音池声音
    public static  void play(int sound, int number){
        AudioManager am = (AudioManager)VoiceTip.context.getSystemService(VoiceTip.context.AUDIO_SERVICE);
